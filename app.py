...
lottie_coding = load_lottiefile("education.json")  # replace link to local lottie file
with st.container():
        st_lottie(
            lottie_coding,
            speed=5,
...
lottie_INVOLVMENT = load_lottiefile("INVOLVMENT.json")  # replace link to local lottie file
